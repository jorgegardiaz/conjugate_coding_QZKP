...
if __name__=='__main__':
    ...
    results.to_csv(f'iter_data_{key_length}_{num_iter}.csv', index=False)
    ...
    # Save to CSV
    df_honest.to_csv(f'honest_data_{key_length}_{num_iter}.csv', index=False)
    df_dishonest.to_csv(f'dishonest_data_{key_length}_{num_iter}.csv', index=False)
